            ...
            <div className="login-container" id="login-container">
                <div className="form-container sign-up-container">
                    <form className="login-form" action='/signup' method='POST'>
                        ...
                        <input name='passsword' type="password" placeholder="Password" />
                        <input type="password" placeholder="Confirm Password" />     
                        <div className="login-button">
                            <button type='submit' id="login-btn-s">Sign Up</button>
                ...
                <div className="form-container sign-in-container">
                    <form className="login-form" method='POST' action='/login'>
                        ...
                        <button type='submit' id="login-btn-l" className="login-btn2">Login</button>
                    </form>
                </div>
